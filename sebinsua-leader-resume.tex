...
\maintitle{Seb Insua}{Tech Lead \& Full-stack Hacker}  % title on top of the document
...
\noindent \emph{Engineer with a passion for product design and a deep interest in the humanities.}
\\
\\
I was sixteen when my fascination with technology really picked up steam. My interest was piqued on discovering a small homebrew community for the handheld gaming device, the GP32. It was inspiring to see a flourishing community of hobbyists creating games for each other and I still believe that we learn best through play. Due to this, I'm very product-focused and often have side projects on-the-go.\newline

My speciality is in combining technical knowledge with lateral thinking. I'm fascinated by interdisciplinary thinking and because of this truly appreciate being part of cross-functional teams. Techwise I have a full-stack skillset but recently have worked mainly in JavaScript, Node.JS, and Swift. My favourite new programming language is Rust. I favour technology philosophies from: \href{http://12factor.net}{the twelve-factor app}, functional programming, micro-services, behaviour-driven development (\acr{BDD}) and \href{http://infoq.com/presentations/Simple-Made-Easy}{Simple Made Easy}.\newline
...
\headedsection
  ...
  \headedsubsection
    ...
    \begin{itemize}[leftmargin=0cm]
      ...
      \item Created some early prototypes using Java + Dropwizard + Swagger.
    \end{itemize}
    }}
}
