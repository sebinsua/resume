...
\headedsection
  {\href{http://theeconomist.com}{The Economist}}
  ...
  \headedsubsection
    ...
    \begin{itemize}[leftmargin=0cm]
      \item React. ES6. Node.
      \item Numerous components used in \href{http://www.theworldin.com}{The World In 2016 project} and potentially other projects, e.g. https://github.com/economist-components/component-articletemplate
    \end{itemize}
    }}
}
