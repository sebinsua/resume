...
\inlineheadsection  % special section that has an inline header with a 'hanging' paragraph
  ...
  {Full-stack software design and implementation. I love to work on on the back-end creating \acr{REST}ful \acr{API}s using Node.JS; but have also worked with mobile technologies like Swift and Cocoa Touch, and on the front-end using JavaScript, \acr{HTML5} and \acr{CSS3}. I follow the mantra \emph{the right tool for the right job} and quickly pick things up.}
...
\headedsection  % sets the header for the section and includes any subsections
  ...
  \headedsubsection  % sets the header for a subsection and contains usually body text
    ...
    \begin{itemize}[leftmargin=0cm]
      ...
      \item I'm currently testing it with early adopters and hope to launch towards the end of the year.
    \end{itemize}
  }}
