...
\headedsection
  ...
  \headedsubsection
    ...
    {\bodytext{
    \begin{itemize}[leftmargin=0cm]
      \item Code reviews. How-to guides. Implementation of 4 Node.js microservices. Improved error handling.
    \end{itemize}    
    }}
}
...
\headedsection
  ...
  \headedsubsection
    ...
    {\bodytext{
    \begin{itemize}[leftmargin=0cm]
      \item Code reviews. Mentoring. Documentation. Architecture. Implementation of a UI using React, Redux and D3.
...
\headedsection
  ...
  \headedsubsection
    ...
    {\bodytext{
    \begin{itemize}[leftmargin=0cm]
      \item Created an Express.js app and numerous React components (e.g. \href{https://github.com/economist-components/component-articletemplate}{@economist/component-articletemplate}) for the \href{http://www.theworldin.com}{The World In 2016}.
    \end{itemize}  
    }}
}
...
\headedsection
  ...
  \headedsubsection
    ...
    {\bodytext{
    \begin{itemize}[leftmargin=0cm]
      \item Rebuilt a sprawling legacy system into a set of 6 Node.js microservices and a React front-end.
    \end{itemize}
    }}
}

\begin{center}
  \emph{Please refer to \href{https://github.com/sebinsua/resume/blob/master/sebinsua-resume-with-career-highlights.pdf}{my full CV} or my \href{http://www.linkedin.com/in/sebinsua}{my Linkedin profile} for the complete list of work experiences.}
\end{center}
