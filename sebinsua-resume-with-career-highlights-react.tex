...
\href{http://gist.github.com/sebinsua}{gist.github.com/sebinsua}\sbull
...
\headedsection
  ...
  \headedsubsection
    ...
    \begin{itemize}[leftmargin=0cm]
      ...
      \item Helped with the upgrade of a large 50+ component React-based design system from v3 of Material UI to v4.
...
\headedsection
  ...
  \headedsubsection
    ...
    \begin{itemize}[leftmargin=0cm]
      ...
      \item D3. React. Redux. Node.js. Golang.
...
\headedsection
  ...
  \headedsubsection
    ...
    \begin{itemize}[leftmargin=0cm]
      \item Rebuilt a sprawling legacy system into 6 Node.js microservices harnessing infrastructure, services and libraries built for the Passport Exemplar project. As part of this project, I also built a CMS using React and integrated this with AD (Kerberos/LDAP).
...
\headedsection
  ...
  \headedsubsection
    ...
    \begin{itemize}[leftmargin=0cm]
      ...
      \item This was also the first time I worked with React.
      \item Node.JS, RabbitMQ, Elasticsearch, React, Redis.
    \end{itemize}
    }}
}
