...
\noindent I am deeply focused on \emph{finding the right problem}. Our industry is beset with cargo-culting and to get better outcomes we must continually ask ourselves whether we're working on the right thing. How can we maximise a businesses \emph{technical leverage} while also reducing its \emph{execution costs}? What is the smaller, more important problem within the problem we're about to work on? What will we cut or delegate? \emph{Do less, better.}
...
\begin{itemize}[leftmargin=0cm]
    ...
    \item \textbf{Setup a Data Engineering/Science Practice from scratch.} This was uncharted waters for me, so I had to use whatever edge I could find.
        ...
        \item I was asked to rapidly hire a team from scratch. In order to avoid making mis-hires, I leveraged a professional relationship to poach a well-respected Data Scientist from another department for my first hire and then setup a robust hiring process.
        \item There were severe issues with the quality of the previous consultancies' work. I created a plan for improvement and communicated this to stakeholders, and then over a few months I led the team to: test the original pipelines, increase the end-to-end performance by ~4x, set up quality control gates, and teach training workshops on modern practices.
        \end{itemize}
...
\headedsection
  ...
  \headedsubsection
    ...
    {\bodytext{\emph{JPMorgan Chase & Co. is an American multinational banking and financial services holding company.}
    \begin{itemize}[leftmargin=0cm]
      \item Helped to lay the foundations necessary for the high-scale software development of a complex realtime trading application built using TypeScript, React and Emotion.
