...
* [Hoist the state of your React components into Redux.](https://github.com/sebinsua/conventional-component)
...
###### **Application Engineer** _Jun '17 – Present_
...
* Worked on a trading application using TypeScript, React, Redux, and RxJS.
* Demonstrated how to use Rollup and Babel 7 to create best-in-class packages that support CommonJS, ES modules and types.
* Evangelised a modern development process leading to multiple teams across the company moving to Lerna monorepos.
* Used working code to [teach best practices on higher-order components, render props, reducer components](https://github.com/sebinsua/react-choices), etc.
...
_The Home Office is a ministerial department of the Government of the United Kingdom, responsible for immigration, security, and law and order._
...
##### **[Saffron Digital](http://saffrondigital.com/)** _London, United Kingdom_
