...
\maintitle{Seb Insua}{Tech Lead \& Consultant Engineer}  % title on top of the document
...
\inlineheadsection  % special section that has an inline header with a 'hanging' paragraph
  {Other:}
  {I've run small standups in the past; I enjoy learning about:
...
\headedsection  % sets the header for the section and includes any subsections
  ...
  \headedsubsection  % sets the header for a subsection and contains usually body text
    ...
    \begin{itemize}[leftmargin=0cm]
      \item \href{https://github.com/sebinsua/conventional-component}{Hoist the state of your React components into Redux.}
...
\headedsection
  ...
  \headedsubsection
    ...
    \begin{itemize}[leftmargin=0cm]
        \item Worked on a complex realtime trading application using TypeScript, React, Redux, and RxJS.
        \item Introduced a CI environment that supports rapid feedback on real work by automatically deploying devsites and posting comments into PRs linking to these. 
        \item Demonstrated how to use Rollup and Babel 7 to create best-in-class packages that support CommonJS, ES modules and types.
        \item Made a declarative interface for an old legacy (and mandated) deployment system.
        \item Made an authenticated and declarative API for the loading and code-splitting of sub-applications.
        \item Used working code to \href{https://github.com/sebinsua/react-choices}{teach best practices on higher-order components, render props, reducer components}, etc.
