...
\maintitle{Seb Insua}{Product Engineer}  % title on top of the document
...
\inlineheadsection  % special section that has an inline header with a 'hanging' paragraph
  ...
  {Full-stack software design and implementation. I love to work on on the back-end creating \acr{REST}ful \acr{API}s using Node.JS; but also know front-end technologies such as JavaScript, React, \acr{HTML5} and \acr{CSS3}. I follow the mantra \emph{the right tool for the right job} and quickly pick things up.}
...
\headedsection  % sets the header for the section and includes any subsections
  ...
  \headedsubsection  % sets the header for a subsection and contains usually body text
    ...
    \begin{itemize}[leftmargin=0cm]
      \item During crunchtime at a London startup I provided after work help on a Phonegap game that allows you to predict the results of future football games.
      ...
      \item Various opensource: a JavaScript object transformation library called \href{https://github.com/sebinsua/jstruct}{Jstruct}, and \href{https://github.com/sebinsua/ramda-debug}{a debugging library for functional programming with Ramda}.
    \end{itemize}
  }}
...
\headedsection
  ...
  \headedsubsection
    ...
    \begin{itemize}[leftmargin=0cm]
      \item A realtime admin system written with ES6 JavaScript, React, Flux and Socket.io.
      \item A full rewrite of a legacy PHP system into a series of Node.js microservices.
    \end{itemize}
    }}
}
