...
\headedsection  % sets the header for the section and includes any subsections
  ...
  \headedsubsection  % sets the header for a subsection and contains usually body text
    ...
    \begin{itemize}[leftmargin=0cm]
      ...
      \item \href{https://github.com/sebinsua/graphviz-config-template}{Graphviz templates as visual configuration of Neo4j database inserts.}
...
\headedsection
  ...
  \begin{itemize}[leftmargin=0cm]
      \item Lead and architect on the HTC Watch project in which I lead a team of five developers. Due to my early work on internationalisation and implementation of multiple payment services we were able to scale this out to 20 countries.
