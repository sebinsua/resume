...
\headedsection
  {\href{https://en.wikipedia.org/wiki/List_of_investment_banks#Largest_full-service_investment_banks}{Investment Bank}}
  {\textsc{London, United Kingdom}} {%
  \headedsubsection
    {Application Engineer}
    {Jun \apo17 -- Present}
    {\bodytext{\emph{Building a trading application at a tier-one investment bank.}
    \begin{itemize}[leftmargin=0cm]
    \end{itemize}
    }}
}
