...
\inlineheadsection  % special section that has an inline header with a 'hanging' paragraph
  {Other:}
  {EI've run small standups in the past; I enjoy learning about:
...
\headedsection
  ...
  \headedsubsection
    {Node.js Engineer}
    {Jan \apo17 -- Apr \apo17}
    {\bodytext{\emph{TYLD is one of London’s fastest growing software engineering consultancies.}
    \begin{itemize}[leftmargin=0cm]
      \item Code reviews. Troubleshooting framework issues. Implementation of 4 Node microservices.
