...
\\
\\
I started programming when I was sixteen after discovering a small homebrew community for a handheld gaming device. It was inspiring to see a flourishing community of hobbyists creating games for each other and I still believe that we learn best through play.\newline

My speciality is in combining technical knowledge with lateral thinking. Technology wise I am full-stack but recently have worked mainly with JavaScript at work and Rust at home.

When getting things done, I favour technology philosophies from: \href{http://12factor.net}{the twelve-factor app}, functional programming, micro-services, unit testing  (\acr{TDD}), the \href{https://github.com/evancz/elm-architecture-tutorial/}{Elm Architecture}, and \href{http://infoq.com/presentations/Simple-Made-Easy}{Simple Made Easy}.\newline

\end{multicols}

\inlineheadsection  % special section that has an inline header with a 'hanging' paragraph
  {Technical specialties:}
  {Full-stack software design and implementation. I follow the mantra \emph{the right tool for the right job} and quickly pick things up. I enjoy working both on the back-end with Node.JS and Rust; and on the front-end with JavaScript and React. I've also done some work with mobile technologies like Swift.}

\inlineheadsection  % special section that has an inline header with a 'hanging' paragraph
  {Leadership, Product \& Operations:}
  {Experience in team leadership (lead teams of 5+ people); multi-faceted approach to product creation: customer development, UX, business modelling, development; ran a Hackathon with 80 participants, etc.}
